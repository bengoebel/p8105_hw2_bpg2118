...
Republicans and Democrats who are governors, representatives and senators. The data set also has a key variable for the political affiliation of the president. In the time frame of this data set, 
...
data than it did for the pols-month data. The key variable in this data set is unemployment_pct, which is the unemployment percentage on 
